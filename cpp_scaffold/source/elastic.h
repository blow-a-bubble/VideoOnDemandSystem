...
namespace bubble
{
    ...
    public:
        ...
        virtual const Json::Value value() const;
    ...
    public:
        ...
        {
            auto element = _subs.find(key);
            if(element == _subs.end())
            {
                return nullptr;
            }
            return std::dynamic_pointer_cast<R>(element->second);
        }
